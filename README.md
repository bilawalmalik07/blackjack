...
- **Realistic Logic**: Handles Ace values (1 or 11) dynamically and follows standard house rules (Dealer stands on 17).
- **Dev Container Ready**: Includes a pre-configured environment for VS Code to get you coding/playing instantly.
